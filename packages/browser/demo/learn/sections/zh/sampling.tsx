  ...
  return (
    <Prose>
      ...
      <p>
        ...
        那条只剩残羹：付完草稿税后只比朴素解码快一点点，而且 draft 得越深税越重（看看「难猜」下的 <code>D = 2</code>{' '}
        反而落在 <code>D = 1</code> 后面）。再看看红色小格对时间线做了什么：什么也没做。被拒的位置从不会把一次前向拉宽——浪费搭的是一趟你反正要付钱的访存。这也正是为什么这个把戏在
