...
| `MLX_BONSAI_HOIST_METADATA=1` | Experimental, default off: materialize rotated PQ2 projection scales/biases in FP32 once at load. Requires FP32 projection inputs; adds about 0.8 GB for Bonsai 2 27B. No stable speedup is claimed. |
