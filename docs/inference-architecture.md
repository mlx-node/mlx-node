...
| Gemma4        | image/audio components that have a paged adapter             | fresh and delta                                                                                                                 | DSpark on paged text state; assistant draft on flat text state                                                                                                                                     | ordinary paged text AR uses grouped full/sliding batching; media and MTP/DSpark remain ordered barriers                   |
