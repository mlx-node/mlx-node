#!/usr/bin/env node
/**
 * Document Layout Analysis + OCR Pipeline (PaddleOCR)
 *
 ...
 *
 * Usage:
 *   oxnode examples/paddle-ocr-pipeline.ts <image_path> [--threshold 0.5] [--vlm-only] [--layout-only]
 *
 * Examples:
 *   oxnode examples/paddle-ocr-pipeline.ts ./examples/ocr.png                # Full pipeline
 *   oxnode examples/paddle-ocr-pipeline.ts ./examples/ocr.png --vlm-only     # VLM OCR only
 *   oxnode examples/paddle-ocr-pipeline.ts ./examples/ocr.png --layout-only  # Layout detection only
 *   oxnode examples/paddle-ocr-pipeline.ts ./examples/ocr.png --threshold 0.3
 *   oxnode examples/paddle-ocr-pipeline.ts ./examples/ocr.png --orient       # With orientation correction
 *   oxnode examples/paddle-ocr-pipeline.ts ./examples/ocr.png --unwarp       # With document unwarping
 */
...
if (!imagePath) {
  console.log('Usage: oxnode examples/paddle-ocr-pipeline.ts <image_path> [options]');
  console.log('Options:');
