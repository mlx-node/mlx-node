...
#define instantiate_reshape_and_cache_impl(kv_type, cache_type, use_fp8, suffix) \
...
// FORKED: Generate both FP8 and non-FP8 variants for each type combination
#define instantiate_reshape_and_cache(kv_type, cache_type)                     \
  instantiate_reshape_and_cache_impl(kv_type, cache_type, false, "");          \
  instantiate_reshape_and_cache_impl(kv_type, cache_type, true, "_fp8");
