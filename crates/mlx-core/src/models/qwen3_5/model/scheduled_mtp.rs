...
impl ScheduledMtpTarget for Qwen35Inner {
    ...
    fn fresh_mtp_draft_caches(&self) -> Vec<Qwen3_5LayerCache> {
        Qwen3_5MTPModule::fresh_caches(&self.config)
    }
...
pub(crate) fn seeded_inner(seed: u64) -> Qwen35Inner {
    ...
    super::paged_construction_tests::cast_qwen35_inner_weights_bf16(&mut inner);
