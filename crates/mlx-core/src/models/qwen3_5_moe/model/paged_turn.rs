...
impl Qwen35MoeInner {
    ...
    pub(super) fn paged_turn_stream_core(
        ...
        // emitter (MoE does not override `stream_emitter`, so it is the
        // default ChatML emitter — byte-identical to the former inline
        // emit).
        ...
        // Flush residual buffered bytes through the bundle's emitter —
        // the default ChatML `on_residual` suppresses reasoning text when
