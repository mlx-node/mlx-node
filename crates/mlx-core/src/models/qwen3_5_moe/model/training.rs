//! Weight-tree walks for Qwen3.5 MoE: checkpoint save/load, the training
//! (GRPO/SFT) bodies the `TrainBackend` forwarders call, parameter extraction,
//! and the `mlx eval` adapter.
